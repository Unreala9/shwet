    ...
    <motion.div
      ...
      animate={
        inView
          ...
          : { opacity: 0, y: 20, scale: 0.9, filter: "blur(5px)" }
      }
    ...
    >
      ...
      {logo ? (
        <img
          ...
          alt={skill}
          draggable={false}
          className="w-9 h-9 object-contain select-none transition-transform duration-500 group-hover:rotate-12 group-hover:scale-110"
      ...
      <span
        className="text-[11px] font-medium text-muted-foreground group-hover:text-foreground/90
...
const CategoryBlock = ({
  ...
  <motion.div
    ...
    transition={{ delay: catIdx * 0.08, duration: 0.6, ease: "easeOut" }}
  >
    {/* Category label */}
